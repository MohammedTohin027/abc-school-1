...
@section('title')
    ABC School | Student-Reg-Fee-Details
@endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Student Registration Fee Details</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a href="{{ route('student.reg.fee.view') }}" class="btn btn-success btn-sm">
                                                <i class="fa fa-list"></i> Registration Fee List
                                            </a>
                                        </li>
                            ...
                            <div class="card-body">
                                <div class="col-md-8 m-auto">
                                    <h5 class="text-center"
                                        ...
                                        Registration Fee</h5>
                                    @php
                                        $registrationfee = App\Models\FreeAmount::where('free_category_id', '1')
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-bold" style="width: 35%">Registration Fee</td>
                                                <td>{{ $originalfee }} TK.</td>
                                            </tr>
                                            <tr>
                                                <td class="text-bold" style="width: 35%">Discount Fee</td>
                                                <td>{{ $discount }} %</td>
                                            </tr>
                                            <tr>
                                                <td class="text-bold" style="width: 35%">Fee (This Student)</td>
                                                <td>{{ $finalfee }} TK.</td>
                                            </tr>
