...
@section('title')
    ABC School | Student-Exam-Fee-Details
@endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Student Exam Fee Details</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a href="{{ route('students.exam.fee.view') }}" class="btn btn-success btn-sm">
                                                <i class="fa fa-list"></i> Exam Fee List
                                            </a>
                                        </li>
                                ...
                                <div class="col-md-8 m-auto">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-bold" style="width: 40%">Exam Fee</td>
                                            ...
                                            <tr>
                                                <td class="text-bold" style="width: 50%">Fee (This Student) of {{ $exam_type_id }}</td>
                                                <td>{{ $finalfee }} TK.</td>
                                            </tr>
