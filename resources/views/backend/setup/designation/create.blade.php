...
@section('title')
    @if (isset($editData))
    ABC School | Setup-Designation-Edit
    @else
    ABC School | Setup-Designation-Create
    @endif
                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('setup.designation.view') }}"> <i
                            ...
                            <div class="card-body">
                                <form action="{{ (@$editData) ? route('setup.designation.update', $editData->id) : route('setup.designation.store') }}" method="POST" role="form" id="myForm">
                                    @csrf
                                    <div class="form-row">
