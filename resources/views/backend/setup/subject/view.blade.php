                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a href="{{ route('setup.subject.create') }}" class="btn btn-success btn-sm"> <i
                                    ...
                                    <tbody>
                                        @foreach ($allData as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('setup.subject.edit', $item->id) }}" class="btn btn-primary btn-sm" title="Edit"><i
