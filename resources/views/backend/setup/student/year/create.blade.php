...
@section('title')
    @if (isset($editData))
    ABC School | Setup-Student-Year-Edit
    @else
    ABC School | Setup-Student-Year-Create
    @endif
                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('setup.student.year.view') }}"> <i
                                                    class="fa fa-list"></i> Student Year List</a>
                                        </li>
                            ...
                            <div class="card-body">
                                <form action="{{ (@$editData) ? route('setup.student.year.update', $editData->id) : route('setup.student.year.store') }}" method="POST" role="form" id="myForm">
                                    @csrf
                                    <div class="form-row">
