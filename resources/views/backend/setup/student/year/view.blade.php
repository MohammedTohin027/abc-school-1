                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a href="{{ route('setup.student.year.create') }}" class="btn btn-success btn-sm"> <i
                                                    class="fa fa-plus-circle"></i> Add Student Year</a>
                                        </li>
                                    ...
                                    <tbody>
                                        @foreach ($allData as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('setup.student.year.edit', $item->id) }}" class="btn btn-primary btn-sm" title="Edit"><i
