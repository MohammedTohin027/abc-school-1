...
@section('title')
    ABC School | Setup-Student-Shift
@endsection
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a href="{{ route('setup.student.shift.create') }}" class="btn btn-success btn-sm"> <i
                                                    class="fa fa-plus-circle"></i> Add Student Shift</a>
                                        </li>
                                    ...
                                    <tbody>
                                        @foreach ($allData as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('setup.student.shift.edit', $item->id) }}" class="btn btn-primary btn-sm" title="Edit"><i
