...
@section('title')
    @if (isset($editData))
    ABC School | Setup-Student-Free-Category-Edit
    @else
    ABC School | Setup-Student-Free-Category-Create
    @endif
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('setup.student.free.category.view') }}"> <i
                                                    class="fa fa-list"></i> Free Category List</a>
                                        </li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    name: {
                        required: "Please enter free category name!",
                    },
                },
                errorElement: 'span',
