...
@section('title')
    @if (isset($editData))
    ABC School | Setup-Student-Group-Edit
    @else
    ABC School | Setup-Student-Group-Create
    @endif
                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('setup.student.group.view') }}"> <i
                                                    class="fa fa-list"></i> Student Group List</a>
                                        </li>
                            ...
                            <div class="card-body">
                                <form action="{{ (@$editData) ? route('setup.student.group.update', $editData->id) : route('setup.student.group.store') }}" method="POST" role="form" id="myForm">
                                    @csrf
                                    <div class="form-row">
