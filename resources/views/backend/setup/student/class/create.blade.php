...
@section('title')
    @if (isset($editData))
    ABC School | Setup-Student-Class-Edit
    @else
    ABC School | Setup-Student-Class-Create
    @endif
                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('setup.student.class.view') }}"> <i
                                                    class="fa fa-list"></i> Student Class List</a>
                                        </li>
                            ...
                            <div class="card-body">
                                <form action="{{ (@$editData) ? route('setup.student.class.update', $editData->id) : route('setup.student.class.store') }}" method="POST" role="form" id="myForm">
                                    @csrf
                                    <div class="form-row">
